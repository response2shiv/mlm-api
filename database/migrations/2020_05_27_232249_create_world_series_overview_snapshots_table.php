...
class CreateWorldSeriesOverviewSnapshotsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('world_series_overviews_snapshots', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('world_series_overview_snapshots');
    }
}
