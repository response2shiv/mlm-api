...
return [
     ...
     */
    'from' => [
        'address' => env('MAILGUN_FROM_ADDRESS', 'support@ncrease.com'),
        'name' => env('MAILGUN_FROM_NAME', 'ibuumerang Support'),
    ],
     ...
     *
     */
    'reply_to' => env('MAILGUN_REPLY_TO', 'support@ncrease.com'),
     ...
     */
    'testmode' => env('MAILGUN_TESTMODE', true)
];
